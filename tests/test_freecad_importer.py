...
import pytest
from plugins.freecad_import.freecad_importer import import_freecad_part, get_freecad_part_parameters
...
def test_parametric_import():
    ...
    result = import_freecad_part(parametric_file_path, parameters = {"mount_dia": {"value": 4.8, "units": "mm"}})
    vol = result.val().Volume()
...
def test_get_parameters():
    ...
    params = get_freecad_part_parameters(parametric_file_path, name_column_letter="A", value_column_letter="B")
    print(params)
